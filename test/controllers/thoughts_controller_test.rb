...
class ThoughtsControllerTest < ActionController::TestCase
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post :create, thought: { description: @thought.description, end_date: @thought.end_date, location: @thought.location, start_date: @thought.start_date, title: @thought.title, venue: @thought.venue }
    end
  ...
  test "should update thought" do
    patch :update, id: @thought, thought: { description: @thought.description, end_date: @thought.end_date, location: @thought.location, start_date: @thought.start_date, title: @thought.title, venue: @thought.venue }
    assert_redirected_to thought_path(assigns(:thought))
  end
